                    ...
                    <div class="container">
                        ...
                        <div class="grid"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p style="line-height: 1.6; color: var(--text-muted);">
                                        ${servicio.descripcionServicio}</p>
                            ...
                            <div class="sidebar">
                                <div class="card" style="position: sticky; top: 2rem;">
                                    <div class="card-body text-center">
                                        <div class="precio-tag"
                                            style="font-size: 2.5rem; font-weight: 800; color: var(--primary); margin-bottom: 1rem;">
                                            $
                                        ...
                                        <c:choose>
                                            <c:when test="${esMiServicio}">
                                                <div class="alert alert-info" style="font-size: 0.9rem;">Este es tu
                                                    propio servicio.</div>
                                                <a href="${pageContext.request.contextPath}/servicio/editar?id=${servicio.idServicio}"
                                                    class="btn btn-outline w-100 mb-2">Editar Servicio</a>
                                            </c:when>
                                            <c:otherwise>
                                                <c:choose>
                                                    <c:when test="${yaSolicite}">
                                                        <div class="alert alert-success" style="font-size: 0.9rem;">Ya
                                                            has solicitado este servicio.</div>
                                                        <a href="${pageContext.request.contextPath}/chat?userId=${proveedor.idUsuario}&servicioId=${servicio.idServicio}"
                                                            class="btn btn-primary w-100">Ir al Chat</a>
                                                    </c:when>
                                                    <c:otherwise>
                                                        ...
                                                        <p class="text-muted mt-2" style="font-size: 0.8rem;">Pagarás
                                                            directamente al compañero al finalizar.</p>
                                                    </c:otherwise>
                                                </c:choose>
                                            </c:otherwise>
                                        </c:choose>
                                ...
                                <a href="${pageContext.request.contextPath}/home" class="btn btn-link w-100 mt-2">←
                                    Volver al inicio</a>
                            </div>
                        </div>
                    </div>
